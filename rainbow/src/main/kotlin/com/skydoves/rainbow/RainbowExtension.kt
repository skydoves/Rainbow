...
public fun Rainbow.color(@ColorInt color: Int): ContextColor = ContextColor(color)

/** creates a list of [ContextColor] using a color list. */
public fun Rainbow.colorList(colors: List<Int>): List<ContextColor> {
  return getColorListFromIntArray(colors)
}

/** creates a list of [ContextColor] using a color list. */
public fun List<Int>.toContextColorList(): List<ContextColor> {
  return getColorListFromIntArray(this)
}

/** creates a list of [ContextColor] using a color array. */
public fun Rainbow.colorArray(colors: IntArray): List<Int> {
  return colors.toList()
}

/** creates a list of [ContextColor] using a color array resource. */
public fun Rainbow.colorArray(@ArrayRes array: Int): List<Int> {
  val colors = view.resources.getIntArray(array)
  return colors.toList()
}

/** creates a list of [ContextColor] using a color array. */
public fun IntArray.toContextColorList(): List<ContextColor> {
